...
number_of_dics = 3  # As in the question 
...
student_1 = Student("Hitin Bhagat", 21105063)
student_2 = Student("Vishesh Indora", 21105056)
student_3 = Student("Priyanshu", 21105060)
print()
...
if count_list_uttered_word == count_list_new_word:
    ...
    while True:
        ...
        print()
        if check == "Y":
            print("Good friends,Indeed :)")
            break
        elif check == "N":
            print("Maybe, you aren't friends after all.")
            break
        else:
